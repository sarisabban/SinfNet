...
|[Nematode Trophic Classification by Head Dataset](https://www.dropbox.com/s/xyuegz9o1qrtki6/Nematodes_Trophic_Head.tar.bz2?dl=0)|ResNet50           |[Weights](https://www.dropbox.com/s/8l5fg3y73oyflae/Nematode_Head.h5?dl=0)                                                                                                  | -----                                                                      |1.0000                 |
|[Nematode Trophic Classification by Body Dataset](https://www.dropbox.com/s/86vh1snh5dg83j7/Nematodes_Trophic_Body.tar.bz2?dl=0)|ResNet50           |[Weights](https://www.dropbox.com/s/5h4r9mdwkcsj8gk/Nematode_Body.h5?dl=0)                                                                                                  | -----                                                                      |0.9861                 |
|[Nematode Object and Semantic Detection Dataset](https://www.dropbox.com/s/d9ab3c4t5q9oyvy/Nematodes.tar.bz2?dl=0)              |YOLOv3 <br /> UNet |[Object Weights](https://www.dropbox.com/s/pnw7im1qmgfunqd/Nematode_Object.h5?dl=0) <br /> [Semantic Weights](https://www.dropbox.com/s/5gi1euj8g1em5yl/unet_binary.h5?dl=0)|[Labels](https://www.dropbox.com/s/cyc3sjcqt3arxpt/Nematode_labels.pkl?dl=0)|0.7365 <br /> 0.9552 <sub>(Images must be 1440x1056)|
...
|python SinfNet.py -B NETWORK MODE LABELS FILENAME RESOLUTION                                                                                        |Calculates nematode biomass from semantic segmentation, where NETWORK (unet, fcn_8), MODE (binary, multi), LABELS .pkl filename (labels.pkl), FILENAME .jpg image and RESOLUTION is the size of a pixel in micrometers|
